...
# ============================================================
# SAME helper (copied from downloader/merge)
# ============================================================
def get_last_week():
...
# ============================================================
# STEP 1: FETCH PROMPT QUALITY (UNCHANGED)
# ============================================================
print("\nFetching prompt quality data...\n")
...
# ============================================================
# STEP 2: LOAD MERGED DATA (ONLY CHANGE HERE)
# ============================================================
print("\nLoading usage data...\n")
